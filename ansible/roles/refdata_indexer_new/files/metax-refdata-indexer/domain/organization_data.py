...
class OrganizationData(IndexableData):
    ...
    ORGANIZATION_PURL_BASE_URL = 'http://uri.suomi.fi/codelist/fairdata/' + \
    ...
    def __init__(
        ...
        super(OrganizationData, self).__init__(org_id, IndexableData.DATA_TYPE_ORGANIZATION, label,
                OrganizationData.ORGANIZATION_PURL_BASE_URL + org_id, same_as, scheme)
        self.parent_id = ''
        if parent_id:
