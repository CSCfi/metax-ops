...
class LocalDataService:
    ...
    LOCAL_REFERENCE_DATA_FILE_FORMAT = {
        ...
        ReferenceData.DATA_TYPE_CHECKSUM_ALGORITHM_TYPE: FILE_TYPE_TXT,
        ReferenceData.DATA_TYPE_RESOURCE_TYPE: FILE_TYPE_TXT,
        ReferenceData.DATA_TYPE_MIME_TYPE: FILE_TYPE_TXT,
        ReferenceData.DATA_TYPE_IDENTIFIER_TYPE: FILE_TYPE_TXT,
